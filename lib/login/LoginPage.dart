...
import 'package:adrian_flutter_login/themes/theme.dart' as Theme;
import 'package:adrian_flutter_login/utilities//bubble_indication_painter.dart';
...
class _LoginPageState extends State<LoginPage>
  ...
  Widget build(BuildContext context) {
    ...
    return ScreenUtil.screenHeight <= 980 ? smallScreenUi() : bigScreenUi();
  }
            ...
            children: <Widget>[
              Padding(
                ...
                child: new Image(
                    ...
                    fit: BoxFit.fill,
                    image:
                        new AssetImage('assets/images/adrian_text_cut1.png')),
              ),
              Padding(
            ...
            children: <Widget>[
              Padding(
                ...
                child: new Image(
                    ...
                    height: 191.0,
                    fit: BoxFit.fill,
                    image: new AssetImage('assets/images/adrian_text.png')),
              ),
              Padding(
                padding: EdgeInsets.only(top: 20.0),
                child: _buildMenuBar(context),
  ...
  logIn(String email, password) async {
    ...
    var response = await http.post("http://68.183.79.24/login/", body: data);
...
//                              new NavigationHomeScreen()));
                      logIn(loginUserNameController.text,
...
//                    splashColor: Theme.Colors.loginGradientEnd,
                      ...
                      onPressed: () => showInSnackBar("Password Reset")),
                ),
              ],
            ),
            SizedBox(
